...
const {
  NEXT_PUBLIC_SANITY_PROJECT_ID="xlyoex12", // Sanity project ID
  NEXT_PUBLIC_SANITY_DATASET="production", // Sanity dataset (e.g., "production")
  NEXT_PUBLIC_SANITY_AUTH_TOKEN="skyVIp9dbRYOQuT14TEExXIt0AHvJs9XPRjQHkveLzBINjPDPyZ6zhDWK2XIjHKOXjIlq63BTWCiajoiMCfwJmXZbi0BCbpeQ17buMboYHELX14S48j9ZlZY41ynktNMBLNiqUMoRriQHCtDqIDuQrHYNIztJzXY074s3ZIpmkuRB5C4N4Ab", // Sanity API token
